...
<div style="background-image: url('{{ asset('assets/image/barber999.jpg') }}'); background-size: cover; background-position: center; width: 100%; height: 100vh;" class="px-20 bg-fixed relative overflow-hidden">
    <div class="lg:absolute top-0 left-0 bg-black opacity-25 w-full h-screen hidden lg:block"></div>
    ...
    <div class="absolute -bottom-24 left-[48%] text-center text-white">
      <img class="img-with-animation animate-spin skip-lazy animated-in" data-delay="0" height="200" width="200" data-animation="none" src="https://themenectar.com/img/demo-media/spinners/scroll-down-light.png" alt="">
    </div>
</div>
...
<section class="container mx-auto">
  @php
      $targetIds = [1045, 1039, 1046]; // Ganti dengan ID yang diinginkan
  @endphp
  <div 
  ...
  <div class="grid grid-cols-3">
    @foreach($dataBearber->take(3) as $barber)
        <div>
            <div class="img-hover-zoom--brightness overflow-hidden w-[80%] cursor-pointer mt-14">
                <img 
            ...
            <p class="mt-10 font-bold text-lg tracking-wider">{{ $barber->job_desk }}</p>
...
<div class="slider relative mt-32">
    <div class="w-[5%] mx-10 cursor-pointer"><img src="{{ asset('assets/image/etch1.jpg') }}" alt="Slide 1" class="h-[41rem] w-full"></div>
    <div class="w-[5%] mx-10 cursor-pointer"><img src="{{ asset('assets/image/etch2.jpg') }}" alt="Slide 1" class="h-[41rem] w-full"></div>
    <div class="w-[5%] mx-10 cursor-pointer"><img src="{{ asset('assets/image/etch3.jpg') }}" alt="Slide 1" class="h-[41rem] w-full"></div>
    <div class="w-[5%] mx-10 cursor-pointer"><img src="{{ asset('assets/image/etch4.jpg') }}" alt="Slide 1" class="h-[41rem] w-full"></div>
    <div class="w-[5%] mx-10 cursor-pointer"><img src="{{ asset('assets/image/etch5.jpg') }}" alt="Slide 1" class="h-[41rem] w-full"></div>
    <!-- Add more slides as needed -->
</div>

<!-- products -->
<section class="w-[60%] mx-auto text-center text-6xl mt-48 mb-60">
