...
<section class="mb-60  w-[75%] mx-auto bg-white p-10 shadow-2xl mt-40">
    <h2 class="text-center text-4xl   font-bold">Paket & Harga</h2>
    ...
    <div class="grid grid-cols-2 text-2xl gap-10 mt-10 ">
        ...
        <div>
            ...
            <p class="text-lg mt-2">{{$serv->deskripsi}}</p>
        </div>
        @endforeach
    </div>
</section>
